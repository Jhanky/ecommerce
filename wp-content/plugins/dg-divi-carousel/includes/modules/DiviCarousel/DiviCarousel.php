...
class DiviCarousel extends ET_Builder_Module {
		...
		$advanced_fields['fonts']  = array(
			...
			'title'   => array(
				...
				'css'      => array(
					...
					'hover' => "%%order_class%% .dica_divi_carouselitem:hover .dica-item-content h4",
					'important' => 'all',
				),
			),
			// Subtitle
			'subtitle'   => array(
				...
				'css'      => array(
					'main' => "%%order_class%% .dica_divi_carouselitem .dica-item-content h5",
					'hover' => "%%order_class%% .dica_divi_carouselitem:hover .dica-item-content h5",
					'important' => 'all',
				),
			),
			// Body Text
				...
				'css'             => array(
					'main' => array(
						'border_radii' => "%%order_class%%.dica_divi_carousel .dica_divi_carouselitem .dica-image-container img.dica-item-image, 
											#et-boc %%order_class%%.dica_divi_carousel .dica_divi_carouselitem .dica-image-container img.dica-item-image",
	...
	public function additional_css_styles($render_slug){
		...
		ET_Builder_Element::set_style($render_slug, array(
			'selector' => '%%order_class%% .dica_divi_carouselitem .et_pb_module_inner, %%order_class%% .dica_divi_carouselitem .et_pb_module_inner *, %%order_class%% .dica_divi_carouselitem .dica-rating span:before',
		...
		$_ex::apply_margin_padding(
			...
			'item_padding', 
			'padding', 
			'%%order_class%% .dica_divi_carouselitem .et_pb_module_inner',
			'%%order_class%% .dica_divi_carouselitem .et_pb_module_inner:hover'
		);
		...
		$_ex::apply_margin_padding(
			...
			'title_margin', 
			'margin', 
			'%%order_class%%.dica_divi_carousel .dica_divi_carouselitem .dica-item-content > h4',
			'%%order_class%%.dica_divi_carousel .dica_divi_carouselitem:hover .dica-item-content > h4'
		);
		$_ex::apply_margin_padding(
			$this,
			$render_slug, 
		...
		$_ex::apply_margin_padding(
			...
			'subtitle_margin', 
			'margin', 
			'%%order_class%%.dica_divi_carousel .dica_divi_carouselitem .dica-item-content > h5',
			'%%order_class%%.dica_divi_carousel .dica_divi_carouselitem:hover .dica-item-content > h5'
		);
		$_ex::apply_margin_padding(
			$this,
			$render_slug, 
		...
		$_ex::apply_element_color(
			...
			'title_background', 
			'background-color', 
			'%%order_class%% .dica-item .dica-item-content > h4',
			'%%order_class%% .dica_divi_carouselitem:hover .dica-item .dica-item-content > h4', 
			true
		);
		// title background color
		$_ex::apply_element_color(
			...
			'subtitle_background', 
			'background-color', 
			'%%order_class%% .dica-item .dica-item-content > h5',
			'%%order_class%% .dica_divi_carouselitem:hover .dica-item .dica-item-content > h5', 
			true
		);
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$data_value = sprintf('data-desktop=%1$s data-tablet=%2$s data-mobile=%3$s data-speed=%4$s
								 ...
								 data-autowidth=%21$s data-item_spacing_tablet=%22$s data-item_spacing_phone=%23$s data-scroller_speed=%24$s', 
								...
								$item_spacing_tablet,
								$item_spacing_phone,
								$this->props['transition_duration_scroll']
							 );
		...
		$output = sprintf( '<div class="dica-container %5$s" %2$s>
